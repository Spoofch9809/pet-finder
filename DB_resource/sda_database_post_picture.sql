...
--
-- Host: localhost    Database: sda_database
-- ------------------------------------------------------
...
CREATE TABLE `post_picture` (
  ...
  UNIQUE KEY `post_picture_id_UNIQUE` (`post_picture_id`),
  KEY `post_picture_to_post_idx` (`post_id`),
  CONSTRAINT `post_picture_to_post` FOREIGN KEY (`post_id`) REFERENCES `post` (`post_id`)
